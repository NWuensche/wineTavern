...
class GuestbookController {
     ...
     * You have to change emailReceiver to your email, so that you receive the comment emails
	 * 
	...
	String addEntry(@Valid GuestbookForm form, Errors errors, Model model) {
        ...
        if (form.getCheckbox() != null) {
                ...
                String emailReceiver = "niklas.wuensche@mailbox.tu-dresden.de";
                EmailTransmitter.sendEmail(form.getName(), form.getText(), emailReceiver);
        }
