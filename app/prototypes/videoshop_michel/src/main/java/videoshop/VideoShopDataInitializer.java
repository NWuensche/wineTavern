...
public class VideoShopDataInitializer implements DataInitializer {
	...
	private void initializeCatalog(VideoCatalog videoCatalog, Inventory<InventoryItem> inventory) {
		...
		videoCatalog.save(new Disc("Anal mit dem Wal", "amdw", Money.of(0.50, EURO), "Porno/Anal", DiscType.DVD, true));
		videoCatalog.save(new Disc("Analstufe Rot", "asr", Money.of(10.99, EURO), "Porno/Anal", DiscType.DVD, true));
		videoCatalog.save(new Disc("Moby Fick", "mf", Money.of(11.90, EURO), "Porno/Casual", DiscType.DVD, true));
		videoCatalog.save(new Disc("Dornmöschen", "dm", Money.of(50.99, EURO), "Porno/Casual", DiscType.DVD, true));
		videoCatalog.save(new Disc("Blackcock down", "bcd", Money.of(20.50, EURO), "Porno/Black", DiscType.DVD, true));
		videoCatalog.save(new Disc("Das Wunder in Bernd", "dwib", Money.of(10.99, EURO), "Porno/Casual", DiscType.DVD, true));
		// (｡◕‿◕｡)
