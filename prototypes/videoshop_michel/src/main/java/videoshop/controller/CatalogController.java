...
class CatalogController {
	...
	public String dvdCatalog(Model model) {
		...
		model.addAttribute("catalog", videoCatalog.findByTypeAndAdult(DiscType.DVD, false));
	...
	public String blurayCatalog(Model model) {
		...
		model.addAttribute("catalog", videoCatalog.findByTypeAndAdult(DiscType.BLURAY, false));
		model.addAttribute("title", messageSourceAccessor.getMessage("catalog.bluray.title"));

		return "discCatalog";
	}

	@RequestMapping("/pornCatalog")
	public String pornCatalog(Model model){
