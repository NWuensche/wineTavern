...
public class Disc extends Product {
	...
	private String genre, image, trailer;
	...
	public Disc(String name, String image, Money price, String genre, DiscType type, String trailer) {
	...
	// Da sowieso nur über die Kommentare iteriert wird, ist ein Iterable<T> das sinnvollste.
